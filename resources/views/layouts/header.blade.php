                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown singleDrop color-1   active ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left">
                            <li class=" active "><a href="index.html">Kidz School</a></li>
                    ...
                    <li class="dropdown singleDrop color-3 ">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list-ul bg-color-3" aria-hidden="true"></i> <span>Periódico</span></a>
                        <ul class="dropdown-menu dropdown-menu-left">
                    ...
                    <li class="dropdown singleDrop color-4 ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li class="dropdown dropdown-submenu">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Checkout<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                                    <li class=" "><a href="checkout-step-1.html">Personal Info</a></li>
                                    <li class=" "><a href="checkout-step-2.html">Payment Info</a></li>
                                    <li class=" "><a href="checkout-step-3.html">Confirmation</a></li>
                    ...
                    <li class="dropdown singleDrop color-6 ">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-gg bg-color-6" aria-hidden="true"></i> <span>Soporte</span></a>
                        <ul class="dropdown-menu dropdown-menu-right">
