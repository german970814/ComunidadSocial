        ...
        <div class="col-md-4 col-sm-6 col-xs-12 block">
            <div class="thumbnail thumbnailContent">
                ...
                <div class="caption border-color-1">
                    <h3 data-original-title="{{ $item->get_nombre() }}" data-placement="bottom" data-toggle="tooltip" title="{{ $item->get_nombre() }}"><a href="{{ route('grupos.show', $item->id) }}" class="color-1">{{ $item->get_nombre() }}</a></h3>
