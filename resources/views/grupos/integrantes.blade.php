...
<section>
    ...
    @include('layouts.title_page', ['title_page' => 'Asesores'])
    <div class="row">
        @foreach ($grupo->asesores() as $asesor)
        <div class="col-sm-3 col-xs-12">
            <div class="teamContent teamAdjust">
                <div class="teamImage">
                    <img src="{{ $asesor->get_profile_photo_url() }}" alt="img-friend" class="img-circle img-responsive">
                    {{-- <div class="maskingContent">
                        <ul class="list-inline">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="teamInfo teamTeacher">
                    <h3><a href="{{ route('usuario.show', $asesor->id) }}">{{ $asesor->get_full_name() }}</a></h3>
                    <p>{{ $asesor->get_tipo_usuario_display() }}</p>
                </div>
            </div>
        </div>
        @endforeach
